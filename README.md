...
![containers_cover_image](./images/cover_image.jpg)

## Contents

1. [Part 1. s21_containers.h library](#part-1-implementation-of-the-s21_containersh-library)    \
    1.1. [Main containers](#main-containers)
2. [Part 2. s21_containersplus.h library](#part-2-implementation-of-the-s21_containersplush-library)    \
    2.1. [Additional containers](#additional-containers)
3. [Part 3. insert_many method](#part-3-implementation-of-the-insert_many-method)


### Part 1. Implementation of the s21_containers.h library

The following `s21_containers.h` library classes are implemented: `list`, `map`, `queue`, `set`, `stack`, `vector`.
- The header file `s21_containers.h` includes different header files with implementations of the specified containers (`s21_list.h`, `s21_map.h` and etc.) 
- Makefile for testing the library is provided
...
### Part 2. Implementation of the s21_containersplus.h library.

The following `s21_containersplus.h` library functions are implemented: `array`, `multiset`.
- The header file `s21_containersplus.h` includes different header files with implementations of the specified containers (`s21_array.h`, `s21_multiset.h`) 
- Makefile for testing the library is provided
...
### Part 3. Implementation of the `insert_many` method.

The above mentioned classes are completed with the appropriate methods, according to the table:
